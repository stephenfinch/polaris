class Polaris extends Circle {
  ...
  getNextTarget(ships) {
    ...
    ships.forEach((ship) => {
      ...
      const shipDistance = this.distance(ship.pos.x, ship.pos.y, ship.r, this.r)
      const nextTargetDistance = this.distance(nextTarget.pos.x, nextTarget.pos.y, ship.r, this.r)
